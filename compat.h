...
#elif defined(__VMS)
  #include <inttypes.h>
/* Must precede the C99 test below: Compaq C V6.5 on Tru64 V5.1 reports
 * __STDC_VERSION__ 199901L under -std, but no Tru64 release ships
 * stdint.h.  The V4.0 compiler reported less and fell through here. */
